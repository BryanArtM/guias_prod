    ...
    .map((it, i) => {
      ...
      return `
        <tr style="height:${ROW_H}px">
          ...
          <td class="celda-desc">
            <div class="desc-linea1">${nombre}</div>
          </td>
          <td class="celda-traz">
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    col.col-traz { width: 150px; }
    col.col-num { width: 70px; }
    col.col-total { width: 85px; }
    ...
    .motivo { margin-top: 10px; font-size: 8.5pt; }
...
<body>
  ...
  <div class="datos-generales">
    <div class="datos-col">
      ...
      <div class="data-row"><span class="data-label">FECHA PRODUCCIÓN:</span><span class="data-value">${fecha_produccion || "-"}</span></div>
  ...
  <div class="motivo">
    <b>MOTIVO DE SALIDA:</b> ${motivo_salida_codigo || "-"}
  </div>
